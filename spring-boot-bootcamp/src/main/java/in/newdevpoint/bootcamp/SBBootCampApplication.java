...
@EnableGlobalMethodSecurity(
    prePostEnabled = true) // Enables method-level security using annotations
// @EnableEurekaClient  // Uncomment to enable service registration with Eureka
public class SBBootCampApplication {
  /** Logger instance for this class. Uses SLF4J for logging with Logback as the implementation. */
  private static final Logger logger = LoggerFactory.getLogger(SBBootCampApplication.class);

  /**
   * Main method that bootstraps the Spring Boot application. This method: 1. Creates the Spring
   * application context 2. Starts the embedded web server 3. Initializes all Spring beans 4.
