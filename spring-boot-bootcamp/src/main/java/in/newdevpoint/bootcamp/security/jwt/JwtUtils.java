...
public class JwtUtils {
     ...
     *
     * The token's subject is set to the user's username, with the issued and expiration dates determined by the current time and configured expiration period.
     *
