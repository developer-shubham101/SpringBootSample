...
/**
 * Service class for handling product-related operations. Includes comprehensive validation before
 * product creation.
 */
@Slf4j
@Service
...
public class ProductService {
  ...
  /**
   * Creates a new product after validating all input fields. Performs both annotation-based
   * validation and custom business rule validation.
   *
  ...
  /**
   * Performs custom business rule validation on the product. This method can be extended with
  ...
  /**
   * Validates if the given category is allowed. This is an example method that can be expanded
   * based on your needs.
   *
